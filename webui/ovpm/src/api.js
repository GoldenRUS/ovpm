...
export const endpoints = {
    authenticate: {
        path: "/auth/authenticate", method: "POST"
    }, authStatus: {
        path: "/auth/status", method: "GET"
    }, genConfig: {
        path: "/user/genconfig", method: "POST"
    }, userList: {
        ...
        path: "/network/list", method: "GET"
    }, vpnStatus: {
        path: "/vpn/status", method: "GET"
    }, vpnRestart: {
        path: "/vpn/restart", method: "POST"
    }, netDefine: {
        path: "/network/create", method: "POST"
    }, netUndefine: {
        path: "/network/delete", method: "POST"
    }, netAssociate: {
        path: "/network/associate", method: "POST"
    }, netDissociate: {
        path: "/network/dissociate", method: "POST"
    }, statisticList: {
        path: "/statistic/list", method: "GET"
    }, systemStatus: {
        path: "/statistic/system/status", method: "GET"
    }, networkInterfaces: {
